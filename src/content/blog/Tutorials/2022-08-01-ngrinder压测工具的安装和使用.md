...
subtitle: "ngrinder压测工具：开源分布式性能测试解决方案"
date: 2022-08-01
tags: [测试开发, 性能]
description: "ngrinder 压测工具从安装到脚本开发的全流程指南，涵盖分布式压测环境搭建、Groovy 脚本编写与性能报告分析。"
---
...
- 下载包
  ...
  - 下载war包 [https://github.com/naver/ngrinder/releases](https://github.com/naver/ngrinder/releases)
  - 下载tomcat (可选操作)
