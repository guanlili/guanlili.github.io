...
date: 2024-03-20
title: "二次开发tabby插件"
subtitle: "开源AI编程助手：本地部署的代码补全利器"
author: "lili"
header-mask: 0.4
description: "基于开源代码补全工具 Tabby 进行二次开发实战，涵盖 IntelliJ IDEA 与 VS Code 插件的定制、编译与本地部署全流程。"
tags: [AI, 代码生成, 开源]
---
# 二次开发tabby插件
...
更多讨论可以访问Tabby社区：[Tabby Slack](https://github.com/TabbyML/tabby/discussions)
