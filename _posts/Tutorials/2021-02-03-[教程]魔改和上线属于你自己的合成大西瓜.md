...
![image-20210203192110628](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203192110.png)
...
![image-20210203192154597](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203192154.png)

下载代码后，我们得到这样的目录结构：

![image-20210203192942923](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203192942.png)可以看到整个代码目录并不复杂，是基于 cocos2d 游戏引擎开发，我们只需要了解几个重要文件：
...
![image-20210203193017692](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203193017.png)
...
![image-20210203193117371](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203193117.png)
...
![image-20210203193132669](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203193132.png)
...
![image-20210203193148737](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203193148.png)

出现游戏界面，本地运行成功，第一步完成！

![image-20210203193436498](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203193436.png)
...
![image-20210203193302029](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203193302.png)
...
![image-20210203194046091](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203194046.png)
...
![image-20210203193510016](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203193510.png)
...
![image-20210203193554178](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203193554.png)
...
![image-20210203193615734](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203193615.png)
...
![image-20210203193636981](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203193637.png)
...
![image-20210203193654141](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203193654.png)
...
![image-20210203193750848](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203193750.png)

然后去修改物理引擎的参数即可，此处设置为 0.9。

![image-20210203193811837](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203193811.png)
...
![image-20210203193927881](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203193927.png)

点击立即创建，开通一个云环境：

![image-20210203194005689](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203194005.png)

授权并开通，同意授权。

![image-20210203194201319](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203194201.png)
...
![image-20210203194223651](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203194223.png)

![image-20210203194300874](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203194300.png)
...
![image-20210203194317608](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203194317.png)
...
![image-20210203194335451](https://cdn.jsdelivr.net/gh/guanlili/PictureBed/img/didimac20210203194335.png)
